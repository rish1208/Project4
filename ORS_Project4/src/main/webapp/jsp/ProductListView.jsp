		...
		<center>
			...
			<table width="100%" align="center">
				<tr>
					...
					<td align="center"><label>ProductAmount</font> :
					</label> <input type="text" name="productAmount"
						placeholder="Enter product Amount"
						value="<%=ServletUtility.getParameter("productAmount", request)%>">
