	...
	<center>
		...
		<form action="<%=ORSView.PRODUCT_CTL%>" method="post">
			...
			<table>
				...
				<th align="left">ProductAmount <span style="color: red">*</span>
					:
				</th>
				<td><input type="text" name="productAmount"
					placeholder="Enter Product Amount" size="26"
					value="<%=DataUtility.getStringData(bean.getProductAmount())%>"></td>
				<td style="position: fixed"><font color="red"> <%=ServletUtility.getErrorMessage("productAmount", request)%></font></td>
				</tr>
				<tr>
				<tr>
					<th style="padding: 3px"></th>
				...
				<%=HTMLUtility.getList("productCatagory", String.valueOf(bean.getProductCatagory()), rList)%>
				<td style="position: fixed"><font color="red"> <%=ServletUtility.getErrorMessage("productCatagory", request)%></font></td>
